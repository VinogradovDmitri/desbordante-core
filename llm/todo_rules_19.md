# todo_rules_19.md — Design review checklist: RULES.md §19 CI awareness — Python wheels

> **Template, not a live todo.** At the start of a **Design-mode** review,
> copy this file into `bin/`:
>
>     cp llm/todo_rules_19.md bin/todo_rules_19.md
>
> then walk it top to bottom as your own todo file for the §19 phase
> (`llm/AGENT.md` "Review workflow"; `llm/CLAUDE.md` §10 S2; `llm/PLAN.md`
> §2).
>
> - Mark a checkbox `in_progress` before reviewing it, `completed`
>   immediately after (S3); keep the `bin/todo_rules_19.md` file and the
...
> - **Delete `bin/todo_rules_19.md` once every checkbox below is
...
Source: `llm/RULES.md` §19 "CI awareness — Python wheels".
Acceptance criterion: every §19 box has a verdict in the report, this
file is fully checked, and it is deleted.

## §19 — CI awareness — Python wheels

- [ ] §19 — Aware that the wheel matrix runs on push to `main`, weekly
      (Mon 03:00 UTC), and on release; skipped on PRs unless the
