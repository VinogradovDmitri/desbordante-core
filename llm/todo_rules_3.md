# todo_rules_3.md — Design review checklist: RULES.md §3 Inline namespaces

> **Template, not a live todo.** At the start of a **Design-mode** review,
> copy this file into `bin/`:
>
>     cp llm/todo_rules_3.md bin/todo_rules_3.md
>
...
>   immediately after (S3); keep the `bin/todo_rules_3.md` file and the
...
> - **Delete `bin/todo_rules_3.md` once every checkbox below is
...
Source: `llm/RULES.md` §3 "Inline namespaces".
Acceptance criterion: every §3 box has a verdict in the report, this
file is fully checked, and it is deleted.

## §3 — Inline namespaces

- [ ] §3 — No implementation-detail inline namespaces (`std::__detail`,
      `std::__cxx11`, `std::_V2`, …)
