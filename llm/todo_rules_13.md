# todo_rules_13.md — Design review checklist: RULES.md §13 Standalone data structures

> **Template, not a live todo.** At the start of a **Design-mode** review,
> copy this file into `bin/`:
>
>     cp llm/todo_rules_13.md bin/todo_rules_13.md
>
...
>   immediately after (S3); keep the `bin/todo_rules_13.md` file and the
...
> - **Delete `bin/todo_rules_13.md` once every checkbox below is
...
Source: `llm/RULES.md` §13 "Standalone data structures".
...
- [ ] §13 — Algorithm-produced structures (e.g. PLI) usable standalone,
      minimal coupling to algorithm objects, no performance harm
