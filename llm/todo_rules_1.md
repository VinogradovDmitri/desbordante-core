# todo_rules_1.md — Design review checklist: RULES.md §1 Supported compilers & build

> **Template, not a live todo.** At the start of a **Design-mode** review,
> copy this file into `bin/`:
>
>     cp llm/todo_rules_1.md bin/todo_rules_1.md
>
...
>   immediately after (S3); keep the `bin/todo_rules_1.md` file and the
...
> - **Delete `bin/todo_rules_1.md` once every checkbox below is
...
Source: `llm/RULES.md` §1 "Supported compilers & build".
...
- [ ] §1 — Builds on Linux GCC 10+ and Linux LLVM Clang 16+
- [ ] §1 — Builds on macOS Apple Clang 16+, macOS GNU GCC 10+, macOS LLVM
      Clang 16+
